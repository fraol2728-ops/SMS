...
import { ReplyForm } from "@/components/admin/reports/ReplyForm";
import { StatusBadge } from "@/components/admin/shared/StatusBadge";
import { Card, CardContent } from "@/components/ui/card";
import { markReportRead } from "@/lib/actions/admin";
...
export default async function ReportDetailPage({
  ...
  if (!report) notFound();
  if (report.status === "UNREAD") await markReportRead(report.id);
